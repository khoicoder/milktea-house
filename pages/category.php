...
<section class="products product-page">
  <div class="container">
    ...
    <div class="products-header" style="text-align: center; margin-bottom: 35px;">
        ...
        <p style="color: #718096; font-size: 15px;">Thưởng thức hương vị đặc trưng của chúng tôi</p>
    </div>
    ...
    <div class="filter-section">
      <form method="GET" class="filter-form">
        ...
        <div style="display: flex; gap: 10px; margin-left: auto;">
            ...
            <?php if ($is_filtering): ?>
                <a href="<?= BASE_URL ?>pages/category.php?id=<?= $category_id ?>" class="btn btn-outline" style="padding: 11px 18px; border-radius: 12px; height: 46px; box-sizing: border-box; display: flex; align-items: center; border-color: #e2e8f0; color: #718096; text-decoration: none;">
                    Xóa lọc
                </a>
            <?php endif; ?>
        </div>
    ...
    <div class="product-grid">
      <?php if ($result && mysqli_num_rows($result) > 0): ?>
        <?php while ($row = mysqli_fetch_assoc($result)): ?>
          ...
          <article class="product-card">
            <a class="product-thumb" href="<?= BASE_URL ?>pages/product_detail.php?id=<?= $product_id ?>">
              <img
            ...
            <div class="product-info">
              <a class="product-name" href="<?= BASE_URL ?>pages/product_detail.php?id=<?= $product_id ?>">
      ...
      <?php else: ?>
        <div class="u-center" style="grid-column:1/-1;padding:60px 0; background: #fff; border-radius: 20px; box-shadow: var(--surface-shadow);">
          ...
          <a href="<?= BASE_URL ?>pages/category.php?id=<?= $category_id ?>" class="btn btn-primary" style="max-width: 200px; margin: 0 auto;">Xem tất cả sản phẩm trong mục này</a>
        </div>
      <?php endif; ?>
    </div>
